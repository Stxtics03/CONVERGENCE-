...
const BOT_REPLIES = [
  "I can help you with a wide range of tasks — writing, analysis, answering questions, brainstorming, or working through complex problems. What would you like to explore?",
  "Sure. Share whatever you'd like written — an email, an essay, a message — and we'll craft it together with care.",
  "Happy to break it down. Complex topics become much clearer when taken step by step. What would you like me to explain?",
  "Great. Tell me what you're working on and I'll help generate ideas, angles, or directions to explore.",
  "Got it. Let me think this through carefully and give you a thorough, useful answer.",
];
